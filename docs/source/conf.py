...
project = 'Gigglebot Micropython Library'
...
htmlhelp_basename = 'GigglebotMicropythonLibrarydoc'
...
latex_documents = [
    (master_doc, 'GigglebotMicropythonLibrary.tex', 'Gigglebot Micropython Library Documentation',
